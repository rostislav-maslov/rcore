...
public class DeleteUserUseCase extends AdminBaseUseCase {
    ...
    public Boolean delete(UserEntity userEntity) throws AuthenticationException, AuthorizationException, TokenExpiredException {
        checkAccess();
        return userRepository.delete(userEntity);
    }

    public Boolean deleteById(String id) throws AuthenticationException, AuthorizationException, TokenExpiredException {
        checkAccess();
