...
class UserPasswordRecoverAdminBaseUseCase extends AdminUseCase {
    ...
    public UserPasswordRecoverAdminBaseUseCase(UserEntity actor, UserPasswordRecoverRepository userPasswordRecoverRepository, Access accessAccess) throws AuthorizationException {
