...
public class EmailAuthenticationTestCase {
    ...
    @Before
    public void before() {
        UserEntity user1 = testAppConfig.getUserRepository().save(AuthenticationTestData.user1(testAppConfig.getPasswordGenerator()));
        UserEntity user2 = testAppConfig.getUserRepository().save(AuthenticationTestData.user2(testAppConfig.getPasswordGenerator()));
    }
    ...
    @Test
    public void authentication() throws UserNotFoundException, UserBlockedException, AuthenticationException {
