 ...
 */
public abstract class AbstractFindByIdUseCase<Id, Entity extends BaseEntity, Repository extends ReadRepository> extends UseCase<AbstractFindByIdUseCase.InputValues<Id>, AbstractFindByIdUseCase.OutputValues<Entity>>  {
