...
//        $($('#modal-user-search-input-name').val()).val(name);
        ...
        $('#modal-user-search-input-id').val(id);
        $('#modal-user-search-input-name').val(name);
    ...
    $(function() {
        $('#btn_parent_user').on('click', function() {
            var id = $('#modal-user-search-input-id').val();
            var name = $('#modal-user-search-input-name').val();
            openModalUserSearch(id, name);
            return false;
        });
        $('#btn_parent_user_clear').on('click', function() {
            $('#modal-user-search-input-id').val('');
            $('#modal-user-search-input-name').val('');
            return false;
        });
    });
</script>